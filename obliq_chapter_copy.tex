\author{Dahlia Baker and Jay McMahon}
...
%\begin{multicols}{2}
\linenumbers
\section{Introduction} \label{introduction} %section 1
%asteroids
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{figures/body_frame_w_obliq.jpg}
...
%HERE I SHOULD SUMMARIZE WHAT SCHEERES DID and WHY IT WAS GENIUS AT THE TIME
\begin{equation}
    \dot{\phi} = \omega
\end{equation}
\begin{equation}
...
%here I can put a diagram of the angles of solar inclination and longitude, then another of obliquity and RA in the inertial frame. Do a quick drawing late
...
%Cite greenwood 2003, cite Scheeres 2007, cite Golubov 2021 for dimensionless versions. Figure out the story of this section and of the paper as a whole. 
...
\begin{figure}
    %here is where plot of bennu omega/omegadot will go
\end{figure}
...
\begin{figure}[H]
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/initial_obliq_dot_dist_bennu.png}
        \caption{}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/initial_obliq_dot_dist_itokawa.png}
        \caption{}
    \end{subfigure}  
    \caption{}
...
\begin{figure}[H]
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/boulder_size_dist_bennu.png}
        \caption{}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/boulder_size_dist_itokawa.png}
        \caption{}
    \end{subfigure}  
    \caption{}
    \label{fig:all_size}
...
\begin{figure}[H]
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/boulder_sizes_biggerthan1_bennu.png}
        \caption{}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/boulder_sizes_biggerthan1_itokawa.png}
        \caption{}
    \end{subfigure}  
    \caption{}
...
\begin{figure}[H]
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/boulder_west_stacked_bennu.png}
        \caption{}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/boulder_west_stacked_itokawa.png}
        \caption{}
    \end{subfigure}  
    \caption{}
...
\begin{figure}[H]
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/location_dists_bennu.png}
        \caption{}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/location_dists_itokawa.png}
        \caption{}
    \end{subfigure}  
    \caption{}
...
%so what does this mean for modeling YORP obliquity instability
%how can we use this to improve YORP models
\subsection{Binaries}
