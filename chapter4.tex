...
The YORP timescale refers to the amount of time it takes for the angular velocity to double or halve as a result of YORP-induced acceleration, and it analytically defined as the current spin rate divided by the spin acceleration. 
\begin{equation}
    \frac{\omega}{\dot{omega}} = \tau_Y = \frac{4\piA^2\sqrt{1-E^2}}{3\Phi} \frac{\omega \rho R^2}{\mathit{C}}
\end{equation}
