...
\section{Previous Studies} \label{background}
...
\begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{yorp.jpeg}
...
The angular acceleration is calculated from orbit parameters (semi-major axis $a$, eccentricity $e$, and obliquity $\epsilon$), mass distribution ($I_z$), and incident solar flux ($G_1$) scaled by the orbit-averaged spin coefficient. The YORP spin coefficient is derived from a global summation of re-emitted thermal radiation over the surface area while within illumination bounds. In future work, the orbit-averaged first-order moment coefficients in the x- and y-directions ($\bar{C}_{1,x}, \bar{C}_{1,y}, \bar{D}_{1,x},$ and $\bar{D}_{1,y}$) may be addressed as they pertain to the change in obliquity over time which leads to coupled changes in the spin. This work is focused on the spin-evolution and will only briefly mention obliquity torques due to boulders here. 
 ...
 \section{Model Design} \label{methods} %section 3
\begin{figure*}[t!]
    \begin{subfigure}{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{bennu_base_facet_yorp.png}
        \caption{Bennu Surface YORP per facet}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{itokawa_base_facet_yorp.png}
...
\begin{figure*}[t]
    \centering
    \includegraphics[width=0.85\textwidth,height=6cm]{wedge_orientations.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.25\textwidth,height=0.4\textwidth]{prism.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{overlaid_shape_symmetry.png}
...
\subsection{Boulder Populations} \label{BP}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{boulder_sizes_power_law.png}
...
\subsection{Simplified Thermal Model} \label{STM}
...
\section{Analysis}\label{analysis} %section 4
...
\begin{figure*}[t!]
    \centering
    \includegraphics[width=0.8\textwidth]{rotating_wedge.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{rotation_plot_one_equator_boulder.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.49\textwidth]{bennu_comparison.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{bennu_impact_size_new.png}
...
\begin{figure*}[t!]
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{bennu_impact_location_new.png}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=0.75\textwidth]{bennu_impact_orient_new.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{itokawa_comparison.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.42\textwidth]{itokawa_impact_size_new.png}
...
\begin{figure*}[t]
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{itokawa_impact_location_new.png}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
        \includegraphics[width=0.75\textwidth]{itokawa_impact_orient_new.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{bennu_difference_yorps.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.42\textwidth]{bennu_comparison_2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.49\textwidth]{bennu_size_binned_spreads.png}
...
\begin{figure*}[t!]
    ...
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{bennu_orient_samesize_recreate.png}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{itokawa_orient_samesize_recreate.png}
    \end{subfigure}
...
\begin{figure*}[t!]
    ...
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{bennu_polar_samesize.png}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{itokawa_polar_samesize.png}
    \end{subfigure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.49\textwidth]{cyorp.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.48\textwidth]{tyorp_regolith.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.49\textwidth]{all_yorps.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.49\textwidth]{error_compare.png}
